                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="contact-left-box position-relative overflow-hidden z-1 bg-primary p-6 d-flex flex-column h-100"
                            ...
                            <p class="fs-sm text-white"><strong>Office Address-1:</strong> Sector-10, Road-12B, Bangladesh
                                - 2542 </p>
                            ...
                            <ul class="contact-list">
                                <li class="d-flex align-items-center gap-3 flex-wrap">
                                    ...
                                    <div class="info">
                                        ...
                                        <h5 class="mb-0 mt-1 text-white">+8801521372452</h5>
                                    </div>
                                </li>
                                <li class="d-flex align-items-center gap-3 flex-wrap mt-3">
                                    ...
                                    <div class="info">
                                        ...
                                        <p class="mb-0 mt-1 text-white fw-medium">cure.forever@gmail.com</p>
                                    </div>
                                </li>
                            </ul>
                            <div class="mt-5">
