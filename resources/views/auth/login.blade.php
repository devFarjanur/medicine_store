                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-5 col-12 bg-white d-flex p-0 tt-login-col shadow">
                        <form class="tt-login-form-wrap p-3 p-md-6 p-lg-6 py-7 w-100" method="POST"
                            ...
                            <div class="mb-7">
                                <a href="index.html">
                                    <img src="{{ asset('backend/assets/images/iconlogo.png') }}" alt="logo">
                                </a>
                            </div>
                            <h2 class="mb-4 h3">Hey there! <br>Welcome back <span class="text-secondary">Forever Cure Pharma</span></h2>
                            <div class="row g-3">
                                <div class="col-sm-12">
